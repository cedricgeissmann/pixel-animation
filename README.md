...
Frage 2: Wir haben 3 verschiedene Backgrounds (BG, BG2, BG3, BG4). Wie kriegen wir es hin, dass in map-01 es BG anzeigt, in map-02 BG2, in map-03 BG3 und un mao-04 BG4 anzeigt? Der Background ist im style.css Zeile 10 festgelegt.
